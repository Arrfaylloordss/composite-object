#pragma once
#ifndef __COMPOSITE_OBJECT_HPP__
#define __COMPOSITE_OBJECT_HPP__
...
public:
    //virtual bool add(const std::shared_ptr<interface> &child) = 0;
    //virtual void push_back(const std::shared_ptr<interface> &child) = 0;
    //virtual bool remove(const unique_id_type &id) = 0;
    //virtual void reserve(const size_t amount) = 0;
    //virtual iterator find(const unique_id_type &id) = 0;
    //virtual void apply(std::function<void(iterator&)> function) = 0;
...
public:
    ...
    /* bool remove(const unique_id_type &id) override
    {
        return false;
    }*/
    ...
    /*void reserve(const size_t amount) override
    {
    }*/

    /*iterator find(const unique_id_type &id) override
    {
        return begin();
    }*/
    ...
    /*template <class T>
    void apply(T &&function) override
    {
        T(*this);
        for (auto &child : *this) apply(function);
    }*/
